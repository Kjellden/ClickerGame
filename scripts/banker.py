...
class Banker(arcade.Sprite):
    def __init__(self, x, y):
        ...
        self.hero = arcade.Sprite(filename= ":resources:images/animated_characters/female_adventurer/femaleAdventurer_idle.png", scale= .5, center_x= 50, center_y=y+ 25)
        self.hero_Name = "Banker"
